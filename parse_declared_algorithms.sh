...
grep -r '\(DECLARE_ALGORITHM\|DECLARE_NEXUS_FILELOADER_ALGORITHM\|DECLARE_FILELOADER_ALGORITHM\|AlgorithmFactory.subscribe\)'\([A-Z]  $sourcedir > $outdir/declared-algorithms
